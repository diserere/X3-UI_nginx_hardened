...
- [x] Исследование Пункта 2 плана (Выпуск Wildcard-сертификатов через DuckDNS).
- [x] Проектирование Пункта 2 плана (Выпуск Wildcard-сертификатов через DuckDNS).
- [x] Проектирование гибридной схемы Nginx Stream+HTTP (Пункт 1 плана).
- [x] Сборка полного Docker-compose стека в концепции Configuration-as-Code (Пункт 3 плана).
- [x] Интеграция сетевой безопасности с файрволом UFW (Пункт 4 плана).
